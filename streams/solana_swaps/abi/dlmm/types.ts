import {Codec, struct, u16, u32, i32, u64, ref, fixedArray, u8, array, bool, option, u128, address, i128, i64, unit, sum, i16} from '@subsquid/borsh'
...
export const LbPair: Codec<LbPair> = struct({
     ...
     * Farming reward information
     */
    rewardInfos: fixedArray(ref(() => RewardInfo), 2),
    /**
     * Oracle pubkey
     */
    oracle: address,
...
export const Position: Codec<Position> = struct({
     ...
     * Farming reward information
     */
    rewardInfos: fixedArray(ref(() => UserRewardInfo), 70),
    /**
     * Swap fee to claim information
     */
    feeInfos: fixedArray(ref(() => FeeInfo), 70),
    /**
     * Lower bin ID
     */
    lowerBinId: i32,
